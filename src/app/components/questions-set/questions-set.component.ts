...
export class QuestionsSetComponent implements OnInit {
	...
	constructor(private formBuilder: FormBuilder, private snackBar: MatSnackBar, private router: Router, public dialog: MatDialog, private examTestService: ExamTestsAndQuestionsService) {}
